# RailsAdmin config file. Generated on May 24, 2012 11:10
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Gargamel', 'Admin']
  ...
  # config.excluded_models = [Category, Item, Role, User]

  # Add models here if you want to go 'whitelist mode':
  config.included_models = [Category, Item, Role, User]
  ...
  #     configure :file_attachment_s3_id, :integer 
  ...
  #     configure :file, :paperclip   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
